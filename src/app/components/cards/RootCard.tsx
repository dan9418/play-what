...
const RootCard: React.FC<any> = () => {
  ...
  const onClear = () => {
    ...
    const sanitized =
      rootIndex === -1 ? pageProps.path : pageProps.path.slice(0, rootIndex);
    navigate(sanitized);
  };
    ...
    <Card
      ...
      css={
        root
          ...
          : `background-color: ${THEME.status.highlight}; border: 1px solid ${THEME.status.warning}; color: ${THEME.text.primary};`
      }
    >
