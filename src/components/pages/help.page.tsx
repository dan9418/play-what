  ...
  return (
    <StyledHelpPage title="Help">
      <Card title="Website Sections">
        ...
        <p>
          The <Link to="/browse">browse</Link> section is an extensive directory
          of many <Link to={getModelRoute(ModelType.Chord)}>chords</Link> and{" "}
          ...
          <p>
            ...
            concept and a few subcategories. There is also a table comparing the
            intervals used to define each chord or scale.
          </p>
          ...
          shape. Template pages do not have a root (key center), so they cannot
          contain any information on specific notes.
        ...
        <p>
          The notes tabs contains inputs for chaning the key center, intervals,
          and display colors.
        </p>
        ...
        <p>
          The search query can include the name and/or key center for any chord
          or scale in the Play What library. It also understands some other
          common keywords:
          <SimpleList
            items={[
              "Major",
      ...
      <Card title="FAQ">
        <ul>
          ...
          <li>
            <div className="q">
              Where can I find more information about Play What and the author?
            </div>
            <div className="ans">
